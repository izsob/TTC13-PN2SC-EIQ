...
/**
 * Pattern-specific match representation of the pn2sc.queries.transitionWithTwoPrePlaces pattern, 
 * to be used in conjunction with {@link TransitionWithTwoPrePlacesMatcher}.
 * 
...
public abstract class TransitionWithTwoPrePlacesMatch extends BasePatternMatch {
  ...
  private TransitionWithTwoPrePlacesMatch(final Transition pT, final Place pP1, final Place pP2) {
    this.fT = pT;
    this.fP1 = pP1;
    this.fP2 = pP2;
  ...
  public List<String> parameterNames() {
    return TransitionWithTwoPrePlacesMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TransitionWithTwoPrePlacesMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TransitionWithTwoPrePlacesMatch other = (TransitionWithTwoPrePlacesMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TransitionWithTwoPrePlacesMatcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends TransitionWithTwoPrePlacesMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends TransitionWithTwoPrePlacesMatch {
