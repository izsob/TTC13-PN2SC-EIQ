...
/**
 * Pattern-specific match representation of the pn2sc.queries.hasRcontains pattern, 
 * to be used in conjunction with {@link HasRcontainsMatcher}.
 * 
...
public abstract class HasRcontainsMatch extends BasePatternMatch {
  private Compound fFrom;
  
  private static List<String> parameterNames = makeImmutableList("from");
  
  private HasRcontainsMatch(final Compound pFrom) {
    this.fFrom = pFrom;
  ...
  public List<String> parameterNames() {
    return HasRcontainsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof HasRcontainsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    HasRcontainsMatch other = (HasRcontainsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return HasRcontainsMatcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends HasRcontainsMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends HasRcontainsMatch {
