...
/**
 * Pattern-specific match representation of the pn2sc.queries.andPrecond pattern, 
 * to be used in conjunction with {@link AndPrecondMatcher}.
 * 
...
public abstract class AndPrecondMatch extends BasePatternMatch {
  private Place fP;
  ...
  private AndPrecondMatch(final Place pP, final Transition pT) {
    this.fP = pP;
    this.fT = pT;
  ...
  public List<String> parameterNames() {
    return AndPrecondMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof AndPrecondMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    AndPrecondMatch other = (AndPrecondMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return AndPrecondMatcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends AndPrecondMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends AndPrecondMatch {
