...
/**
 * Pattern-specific match representation of the pn2sc.queries.preT pattern, 
 * to be used in conjunction with {@link PreTMatcher}.
 * 
...
public abstract class PreTMatch extends BasePatternMatch {
  private Place fP;
  ...
  private PreTMatch(final Place pP, final Transition pT) {
    this.fP = pP;
    this.fT = pT;
  ...
  public List<String> parameterNames() {
    return PreTMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof PreTMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  public Pattern pattern() {
    try {
    	return PreTMatcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends PreTMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends PreTMatch {
