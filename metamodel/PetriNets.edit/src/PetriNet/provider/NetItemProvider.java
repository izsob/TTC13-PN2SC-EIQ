...
public class NetItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetriNetPackage.Literals.NET__PLACES);
			childrenFeatures.add(PetriNetPackage.Literals.NET__TRANSITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetriNetPackage.Literals.NET__PLACES,
				 PetriNetFactory.eINSTANCE.createPlace()));

		newChildDescriptors.add
			(createChildParameter
				(PetriNetPackage.Literals.NET__TRANSITIONS,
