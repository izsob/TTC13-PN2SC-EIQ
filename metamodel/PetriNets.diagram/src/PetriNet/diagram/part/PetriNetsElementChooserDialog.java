 ...
 * @generated
 */
public class PetriNetsElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public PetriNetsElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						PetriNet.diagram.part.Messages.PetriNetsElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "PetriNet".equals(fileExtension); //$NON-NLS-1$
	}
