...
public class WrappingLabel2EditPart extends LabelEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new PetriNet.diagram.edit.policies.PetriNetsTextSelectionEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new PetriNet.diagram.edit.parts.NetEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PetriNet.diagram.providers.PetriNetsParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					PetriNet.diagram.edit.parts.PetriNetsEditPartFactory
