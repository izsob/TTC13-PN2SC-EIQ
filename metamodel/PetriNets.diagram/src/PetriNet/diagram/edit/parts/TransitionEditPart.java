...
public class TransitionEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof PetriNet.diagram.edit.parts.TransitionNameEditPart) {
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(15, 50);
		return result;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PetriNet.diagram.part.PetriNetsVisualIDRegistry
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(PetriNet.diagram.providers.PetriNetsElementTypes.TransitionPostp_4002);
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == PetriNet.diagram.providers.PetriNetsElementTypes.TransitionPostp_4002) {
	...
	public List<IElementType> getMARelTypesOnTarget() {
		ArrayList<IElementType> types = new ArrayList<IElementType>(1);
		types.add(PetriNet.diagram.providers.PetriNetsElementTypes.PlacePostt_4001);
		return types;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == PetriNet.diagram.providers.PetriNetsElementTypes.PlacePostt_4001) {
			types.add(PetriNet.diagram.providers.PetriNetsElementTypes.Place_2001);
		}
		return types;
	}
