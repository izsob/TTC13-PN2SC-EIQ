...
public class NetEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "PetriNets"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PetriNet.diagram.edit.policies.NetItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PetriNet.diagram.edit.policies.NetCanonicalEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						PetriNet.diagram.part.PetriNetsVisualIDRegistry.TYPED_INSTANCE));
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new PetriNet.diagram.edit.commands.PetriNetsCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
