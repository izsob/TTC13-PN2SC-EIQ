...
import statecharts.diagram.part.StateChartsDiagramEditor;
 ...
 * @generated
 */
public class StateChartsNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof StateChartsNavigatorItem) {
					selectedElement = ((StateChartsNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (StatechartEditPart.MODEL_ID
							.equals(StateChartsVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, StateChartsDiagramEditor.ID);
