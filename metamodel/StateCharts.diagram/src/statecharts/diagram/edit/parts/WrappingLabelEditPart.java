...
public class WrappingLabelEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				StateChartsVisualIDRegistry
						.getType(statecharts.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new StatechartEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StateChartsParserProvider.getParser(
					StateChartsElementTypes.StateNext_4001, getParserElement(),
