 ...
 * @generated
 */
public class BasicNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BasicNameEditPart(View view) {
		super(view);
	}
			...
			parser = StateChartsParserProvider
					.getParser(
							...
							StateChartsVisualIDRegistry
									.getType(statecharts.diagram.edit.parts.BasicNameEditPart.VISUAL_ID));
		}
		return parser;
	}
