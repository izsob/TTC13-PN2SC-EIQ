...
import statecharts.diagram.edit.commands.StateChartsCreateShortcutDecorationsCommand;
import statecharts.diagram.edit.policies.StatechartCanonicalEditPolicy;
import statecharts.diagram.edit.policies.StatechartItemSemanticEditPolicy;
...
public class StatechartEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "StateCharts"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						StateChartsVisualIDRegistry.TYPED_INSTANCE));
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new StateChartsCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
