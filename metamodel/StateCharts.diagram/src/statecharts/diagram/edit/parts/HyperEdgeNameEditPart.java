...
import statecharts.diagram.edit.policies.StateChartsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class HyperEdgeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HyperEdgeNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new StateChartsTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new StatechartEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StateChartsParserProvider
					.getParser(
							StateChartsElementTypes.HyperEdge_3003,
							getParserElement(),
							StateChartsVisualIDRegistry
									.getType(statecharts.diagram.edit.parts.HyperEdgeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					StateChartsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
