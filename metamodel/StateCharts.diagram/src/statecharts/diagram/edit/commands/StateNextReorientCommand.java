...
public class StateNextReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return StateChartsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistStateNext_4001(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return StateChartsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistStateNext_4001(getOldSource(), getNewTarget());
	}
