 ...
 * @generated
 */
public class StateChartsMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = StateChartsDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			StateChartsDiagramEditorUtil.selectElementsInDiagram(editor,
