 ...
 * @generated
 */
public class StateChartsValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = StateChartsDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof StateChartsDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& StatechartEditPart.MODEL_ID
						.equals(StateChartsVisualIDRegistry.getModelID(view));
	}
