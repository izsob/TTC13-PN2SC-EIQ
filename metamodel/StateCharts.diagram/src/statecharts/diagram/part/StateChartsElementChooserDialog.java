 ...
 * @generated
 */
public class StateChartsElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public StateChartsElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.StateChartsElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "statechart".equals(fileExtension); //$NON-NLS-1$
	}
