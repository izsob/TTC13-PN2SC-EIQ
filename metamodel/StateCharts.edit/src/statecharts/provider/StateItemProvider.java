...
/**
 * This is the item provider adapter for a {@link statecharts.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRnextPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatechartsPackage.Literals.STATE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatechartsPackage.Literals.STATE__NEXT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Rnext feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRnextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_rnext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_rnext_feature", "_UI_State_type"),
				 StatechartsPackage.Literals.STATE__RNEXT,
				 true,
				 false,
				 true,
				 null,
	...
	public ResourceLocator getResourceLocator() {
		return StateChartsEditPlugin.INSTANCE;
	}
